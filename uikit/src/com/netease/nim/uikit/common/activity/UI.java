...
//        }
        if (options.titleId != 0 || !TextUtils.isEmpty(options.titleString)) {
            if (options.titleId != 0) {
                options.titleString = getResources().getString(options.titleId);
            }
//            toolbar.setTitle(options.titleString);
            toolbar.setTitle("");
            TextView toolbar_title = (TextView) findViewById(R.id.toolbar_title);
            if (null != toolbar_title) {
                toolbar_title.setText(options.titleString);
            }
        }
        if (options.logoId != 0) {
        ...
        if (options.background != 0) {
            toolbar.setBackgroundColor(getResources().getColor(options.background));
        }
