...
import com.netease.nim.uikit.MySharedPreferences;
...
public class AdvancedTeamMemberInfoActivity extends UI implements View.OnClickListener {
    ...
    private View dealerCodeContainer;
    private View dealerNameContainer;
    ...
    private void findViews() {
        ...
        dealerCodeContainer = findViewById(R.id.dealerCode_container);
        dealerNameContainer = findViewById(R.id.dealerName_container);
        ...
        phone = (TextView) findViewById(R.id.team_member_phone_detail);
        email = (TextView) findViewById(R.id.team_member_email_detail);
        dealerCode = (TextView) findViewById(R.id.team_member_dealerCode_detail);
        dealerName = (TextView) findViewById(R.id.team_member_dealerName_detail);
        setUserInfo();
    ...
    private void setUserInfo() {
        String phoneText = MySharedPreferences.getInstance().getString("phone", AdvancedTeamMemberInfoActivity.this);
        String emailText = MySharedPreferences.getInstance().getString("email", AdvancedTeamMemberInfoActivity.this);
        String dealerCodeText = MySharedPreferences.getInstance().getString("dealerCode", AdvancedTeamMemberInfoActivity.this);
        String dealerNameText = MySharedPreferences.getInstance().getString("dealerName", AdvancedTeamMemberInfoActivity.this);
        phone.setText(phoneText);
        email.setText(emailText);
        dealerCode.setText(dealerCodeText);
        dealerName.setText(dealerNameText);

        String nimAccount = MySharedPreferences.getInstance().getString("NimAccount", AdvancedTeamMemberInfoActivity.this);
        String teamId = MySharedPreferences.getInstance().getString("NimAccountCurrentTeamId", AdvancedTeamMemberInfoActivity.this);
        TeamMember teamMember = TeamDataCache.getInstance().getTeamMember(teamId, nimAccount);
        if (null != teamMember && (teamMember.getType() == TeamMemberType.Manager || teamMember.getType() == TeamMemberType.Owner)) {
