...
//    private TextView teamBusinessCard; // 我的群名片
    ...
    private RelativeLayout teamMember;
...
//
        ...
        teamMember = (RelativeLayout) findViewById(R.id.teamMember);
        teamMember.setOnTouchListener(new View.OnTouchListener() {
...
//                AdvancedTeamAnnounceActivity.start(AdvancedTeamInfoActivity.this, teamId);
        ...
        ((TextView) layoutTeamName.findViewById(R.id.item_detail)).setCompoundDrawables(null, null, null, null);
        ((TextView) layoutTeamIntroduce.findViewById(R.id.item_detail)).setCompoundDrawables(null, null, null, null);
        ((TextView) layoutTeamAnnouncement.findViewById(R.id.item_detail)).setCompoundDrawables(null, null, null, null);
    ...
    private void initNotify() {
        ...
        ((TextView) layoutNotificationConfig.findViewById(R.id.item_detail)).setCompoundDrawables(null, null, null, null);
    }
...
//    }
    ...
    private void updateTeamInfo(final Team t) {
        ...
        teamIdText.setText(String.format("课堂ID：%s", team.getId()));
        teamCreateTimeText.setText(String.format("%s%s", TimeUtil.getDateTimeString(team.getCreateTime(), "yyyy年MM月dd日"), TimeUtil.getTodayTimeBucket(new Date(team.getCreateTime()))));
...
//                teamBusinessCard.setText(nickname);
    ...
    public void onHeadImageViewClick(String account) {
        AdvancedTeamMemberActivity.startActivityForResult(AdvancedTeamInfoActivity.this, teamId, REQUEST_CODE_MEMBER_LIST);
//        String nimAccount = MySharedPreferences.getInstance().getString("NimAccount", AdvancedTeamInfoActivity.this);
//        String teamId = MySharedPreferences.getInstance().getString("NimAccountCurrentTeamId", AdvancedTeamInfoActivity.this);
//        TeamMember teamMember = TeamDataCache.getInstance().getTeamMember(teamId, account);
//        if (!account.equals(nimAccount) && teamMember.getType() != TeamMemberType.Owner) {
//            // 打开群成员信息详细页面
