package com.zhongdasoft.svwtrainnet.imdemo.contact.activity;
...
import com.zhongdasoft.svwtrainnet.imdemo.contact.constant.UserConstant;
import com.zhongdasoft.svwtrainnet.imdemo.contact.helper.UserUpdateHelper;
import com.zhongdasoft.svwtrainnet.imdemo.main.model.Extras;
...
public class UserProfileSettingActivity extends UI implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_user_profile_set_activity);
    ...
    private void updateAvatar(final String path) {
        ...
        LogUtil.i(TAG, "start upload avatar, local chat_file path=" + file.getAbsolutePath());
