...
import com.zhongdasoft.svwtrainnet.imdemo.contact.activity.UserProfileSettingActivity;
import com.zhongdasoft.svwtrainnet.imdemo.jsbridge.JsBridgeActivity;
import com.zhongdasoft.svwtrainnet.imdemo.main.adapter.SettingsAdapter;
import com.zhongdasoft.svwtrainnet.imdemo.main.model.SettingTemplate;
import com.zhongdasoft.svwtrainnet.imdemo.main.model.SettingType;
...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener {
    ...
    private void initUI() {
        ...
        View footer = LayoutInflater.from(this).inflate(R.layout.chat_settings_logout_footer, null);
...
//                break;
    ...
    private void logout() {
        removeLoginState();
        ChatMainActivity.logout(SettingsActivity.this, false);
