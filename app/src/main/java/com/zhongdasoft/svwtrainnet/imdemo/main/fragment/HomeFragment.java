...
import com.zhongdasoft.svwtrainnet.imdemo.common.ui.viewpager.FadeInOutPageTransformer;
import com.zhongdasoft.svwtrainnet.imdemo.main.activity.ChatMainActivity;
import com.zhongdasoft.svwtrainnet.imdemo.main.adapter.MainTabPagerAdapter;
...
//    private PagerSlidingTabStrip tabs;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.chat_main, container, false);
        return rootView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        options.titleString = "消息中心";
        ((ChatMainActivity) getActivity()).setToolBar(R.id.toolbar, options);
//        setToolBar(R.id.toolbar, R.string.app_name, R.drawable.chat_actionbar_dark_logo);
...
//                return R.layout.chat_tab_layout_main;
//            }
//
//            @Override
