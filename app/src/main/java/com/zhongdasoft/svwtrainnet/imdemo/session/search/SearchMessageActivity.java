package com.zhongdasoft.svwtrainnet.imdemo.session.search;
...
public class SearchMessageActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_message_search_activity);
    ...
    private void initSearchListView() {
        ...
        searchResultListView.setEmptyView(LayoutInflater.from(this).inflate(R.layout.chat_message_search_empty_view, null));
