package com.zhongdasoft.svwtrainnet.imdemo.session.activity;
...
import com.zhongdasoft.svwtrainnet.imdemo.contact.activity.UserProfileActivity;
...
public class MessageInfoActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_message_info_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = R.string.message_info;
        options.navigateId = R.drawable.chat_actionbar_dark_back_icon;
