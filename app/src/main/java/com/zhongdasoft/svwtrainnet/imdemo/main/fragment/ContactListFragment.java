...
import com.zhongdasoft.svwtrainnet.imdemo.contact.activity.BlackListActivity;
import com.zhongdasoft.svwtrainnet.imdemo.main.activity.SystemMessageActivity;
import com.zhongdasoft.svwtrainnet.imdemo.main.activity.TeamListActivity;
import com.zhongdasoft.svwtrainnet.imdemo.main.helper.SystemMessageUnreadManager;
import com.zhongdasoft.svwtrainnet.imdemo.main.reminder.ReminderId;
import com.zhongdasoft.svwtrainnet.imdemo.main.reminder.ReminderItem;
    ...
    public final static class FuncItem extends AbsContactItem {
        ...
        public static final class FuncViewHolder extends AbsContactViewHolder<FuncItem> {
            ...
            public View inflate(LayoutInflater inflater) {
                View view = inflater.inflate(R.layout.chat_func_contacts_item, null);
            ...
            public void refresh(ContactDataAdapter contactAdapter, int position, FuncItem item) {
                if (item == VERIFY) {
                    ...
                    image.setImageResource(R.drawable.chat_icon_verify_remind);
                    ...
                    image.setImageResource(R.drawable.chat_ic_secretary);
                } else if (item == ADVANCED_TEAM) {
                    funcName.setText("高级群");
                    image.setImageResource(R.drawable.chat_ic_advanced_team);
                } else if (item == BLACK_LIST) {
                    funcName.setText("黑名单");
                    image.setImageResource(R.drawable.chat_ic_black_list);
                } else if (item == MY_COMPUTER) {
                    funcName.setText("我的电脑");
                    image.setImageResource(R.drawable.chat_ic_my_computer);
                }
