...
package com.zhongdasoft.svwtrainnet.imdemo.common.ui.viewpager;
...
import com.zhongdasoft.svwtrainnet.imdemo.main.reminder.ReminderSettings;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private void addTabView(final int position, String title) {
        ...
        if (tabView == null) {
            tabView = inflater.inflate(R.layout.chat_tab_layout_main, null);
        }
