package com.zhongdasoft.svwtrainnet.imdemo.session;
...
import com.zhongdasoft.svwtrainnet.imdemo.session.action.SnapChatAction;
import com.zhongdasoft.svwtrainnet.imdemo.session.action.TipAction;
import com.zhongdasoft.svwtrainnet.imdemo.session.activity.MessageHistoryActivity;
import com.zhongdasoft.svwtrainnet.imdemo.session.activity.MessageInfoActivity;
import com.zhongdasoft.svwtrainnet.imdemo.session.extension.CustomAttachParser;
import com.zhongdasoft.svwtrainnet.imdemo.session.extension.CustomAttachment;
...
import com.zhongdasoft.svwtrainnet.imdemo.session.search.SearchMessageActivity;
import com.zhongdasoft.svwtrainnet.imdemo.session.viewholder.MsgViewHolderDef;
import com.zhongdasoft.svwtrainnet.imdemo.session.viewholder.MsgViewHolderDefCustom;
import com.zhongdasoft.svwtrainnet.imdemo.session.viewholder.MsgViewHolderFile;
import com.zhongdasoft.svwtrainnet.imdemo.session.viewholder.MsgViewHolderGuess;
import com.zhongdasoft.svwtrainnet.imdemo.session.viewholder.MsgViewHolderMulti;
import com.zhongdasoft.svwtrainnet.imdemo.session.viewholder.MsgViewHolderSnapChat;
import com.zhongdasoft.svwtrainnet.imdemo.session.viewholder.MsgViewHolderSticker;
import com.zhongdasoft.svwtrainnet.imdemo.session.viewholder.MsgViewHolderTip;
...
//            p2pCustomization.backgroundUri = "chat_file:///android_asset/xx/bk.jpg";
//            p2pCustomization.backgroundUri = "chat_file:///sdcard/Pictures/bk.png";
//            p2pCustomization.backgroundUri = "android.resource://com.zhongdasoft.svwtrainnet.imdemo/drawable/bk"
...
//        NimUIKit.registerMsgItemViewHolder(AVChatAttachment.class, MsgViewHolderAVChat.class);
        ...
        NimUIKit.registerMsgItemViewHolder(MultiAttachment.class, MsgViewHolderMulti.class);
        NimUIKit.registerMsgItemViewHolder(DefAttachment.class, MsgViewHolderDef.class);
...
//                String nimAccount = MySharedPreferences.getInstance().getString("NimAccount", context);
//                String teamId = com.netease.nim.uikit.MySharedPreferences.getInstance().getString("NimAccountCurrentTeamId", context);
//                TeamMember teamMember = TeamDataCache.getInstance().getTeamMember(teamId, message.getFromAccount());
//                if (!message.getFromAccount().equals(nimAccount) && teamMember.getType() != TeamMemberType.Owner) {
//                    // 打开群成员信息详细页面
//                    AdvancedTeamMemberInfoActivity.startActivityForResult((TeamMessageActivity) context, message.getFromAccount(), teamId);
//                }
            }
