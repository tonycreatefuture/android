...
public class BusSegmentListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(mContext, R.layout.map_item_bus_segment, null);
        ...
        if (position == 0) {
            holder.busDirIcon.setImageResource(R.drawable.map_dir_start);
            ...
            holder.busDirIcon.setImageResource(R.drawable.map_dir_end);
            ...
            if (item.isWalk() && item.getWalk() != null) {
                holder.busDirIcon.setImageResource(R.drawable.map_dir13);
                holder.busDirUp.setVisibility(View.VISIBLE);
                holder.busDirDown.setVisibility(View.VISIBLE);
                ...
                holder.busDirIcon.setImageResource(R.drawable.map_dir14);
                holder.busDirUp.setVisibility(View.VISIBLE);
                holder.busDirDown.setVisibility(View.VISIBLE);
    ...
    private class ArrowClick implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (mHolder.arrowExpend == false) {
                ...
                mHolder.busExpandImage
                        .setImageResource(R.drawable.map_up);
                ...
                mHolder.busExpandImage
                        .setImageResource(R.drawable.map_down);
        ...
        private void addBusStation(BusStationItem station) {
            LinearLayout ll = (LinearLayout) View.inflate(mContext,
                    R.layout.map_item_bus_segment_ex, null);
