...
import com.zhongdasoft.svwtrainnet.module.home.EvaluationFragment;
...
public class EvaluateFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    private String[] tabTitles = new String[]{"线下课程", "辅导课程"};
    private boolean[] fragmentsUpdateFlag = new boolean[]{false, false};
    FragmentManager fm;

    public EvaluateFragmentPagerAdapter(FragmentManager fm, WeakReference<? extends BaseActivity> wr) {
        super(fm);
        this.fm = fm;
        this.wr = wr;
    }
    ...
    public Fragment getItem(int position) {
        return EvaluationFragment.newInstance(position, wr);
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (fragmentsUpdateFlag[position % fragmentsUpdateFlag.length]) {
            ...
            ft.remove(fragment);
            //换成新的fragment
            fragment = EvaluationFragment.newInstance(position, wr);
