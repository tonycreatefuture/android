...
public class DriveSegmentListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext, R.layout.map_item_bus_segment,
					null);
		...
		if (position == 0) {
			holder.driveDirIcon.setImageResource(R.drawable.map_dir_start);
			...
			holder.driveDirIcon.setImageResource(R.drawable.map_dir_end);
