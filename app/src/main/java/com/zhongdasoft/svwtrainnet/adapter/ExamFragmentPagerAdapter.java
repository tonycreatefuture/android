...
import com.zhongdasoft.svwtrainnet.module.exam.TestFragment;
...
public class ExamFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    private String[] tabTitles = new String[]{"考试任务", "已完成"};
    private boolean[] fragmentsUpdateFlag = new boolean[]{false, false};
    FragmentManager fm;

    public ExamFragmentPagerAdapter(FragmentManager fm, WeakReference<? extends BaseActivity> wr) {
        super(fm);
        this.fm = fm;
        this.wr = wr;
    }
    ...
    public Fragment getItem(int position) {
        return TestFragment.newInstance(position, wr);
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (fragmentsUpdateFlag[position % fragmentsUpdateFlag.length]) {
            ...
            ft.remove(fragment);
            //换成新的fragment
            fragment = TestFragment.newInstance(position, wr);
