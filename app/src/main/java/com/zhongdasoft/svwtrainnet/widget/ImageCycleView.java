...
import com.zhongdasoft.svwtrainnet.adapter.CycleViewPager;
...
public class ImageCycleView extends LinearLayout {
     ...
     */
    public void setImageResources(ArrayList<HashMap<String, Object>> infoList, ImageCycleViewListener imageCycleViewListener) {
        // 清除所有子视图
    ...
    public interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        void onImageClick(HashMap<String, Object> info, int position, View imageView);
    }
    ...
    private class ImageCycleAdapter extends PagerAdapter {
         ...
         * 图片资源列表
         */
        private ArrayList<HashMap<String, Object>> mAdList = new ArrayList<>();
        ...
        public ImageCycleAdapter(Context context, ArrayList<HashMap<String, Object>> adList, ImageCycleViewListener imageCycleViewListener) {
            mContext = context;
            mAdList = adList;
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            String imageUrl = StringUtil.objectToStr(mAdList.get(position).get("PictureUrl"));
