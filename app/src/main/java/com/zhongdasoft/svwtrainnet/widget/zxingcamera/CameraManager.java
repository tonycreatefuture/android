    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            if (null != screenResolution) {
                minValue = Math.min(screenResolution.x, screenResolution.y);
            }
            int width = minValue / 2;
            int height = minValue / 2;
...
//      }
            int leftOffset = (minValue - width) / 2;
            int topOffset = (minValue - width) / 3;
            if (null != screenResolution) {
