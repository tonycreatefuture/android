            ...
            if (showResponse)
            {
                ...
                if (body != null)
                {
                    ...
                    if (mediaType != null)
                    {
                        ...
                        {
                            Log.e(tag, "responseBody's content : " + " maybe [chat_file part] , too large too print , ignored!");
                        }
                    }
                }
            }
        ...
        try
        {
            ...
            if (requestBody != null)
            {
                ...
                if (mediaType != null)
                {
                    ...
                    {
                        Log.e(tag, "requestBody's content : " + " maybe [chat_file part] , too large too print , ignored!");
                    }
                }
            }
